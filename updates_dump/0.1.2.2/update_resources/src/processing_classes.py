import pygame,json
with open("minecraft/assets/config/game/structures/natural/oak_tree.json","r") as file:
...
class renderingWorldClass:
    ...
    def graphicFiles(self):
        self.fontMojangles =  pygame.font.Font("minecraft/assets/fonts/font_mojangles_regular.otf", 33)
        self.rectOfTile = pygame.Rect(0,0,16,16)
        self.tree = oakTree
        self.tileMetaData = dict(json.load(open('minecraft/assets/textures/game/block_metadata/png_block_identifier.json', 'r')))
        self.atlas = pygame.image.load('minecraft/assets/textures/game/block_textures/block_atlas.png')
